...
class PreviewView: UIView, UIGestureRecognizerDelegate {
	...
	*/
	...
	/// A dot with white fill color on the top left of the region of interest.
	private let topLeftControl = CAShapeLayer()
	
	/// A dot with white fill color on the top right of the region of interest.
	private let topRightControl = CAShapeLayer()
	
	/// A dot with white fill color on the bottom left of the region of interest.
	private let bottomLeftControl = CAShapeLayer()
	
	/// A dot with white fill color on the bottom right of the region of interest.
